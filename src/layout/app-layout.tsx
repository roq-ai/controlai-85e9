...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['organization-owner', 'compliance-manager', 'documentation-specialist'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Ai Models', path: '/ai-models', entity: 'ai_model', service: AccessServiceEnum.PROJECT, icon: FiCpu },
    {
