...
import { useAiModelFindFirst, useRoqClient } from 'lib/roq';

import { AiModelInterface } from 'interfaces/ai-model';
import { ComplianceTestListPage } from 'pages/compliance-tests';
...
function AiModelViewPage() {
  ...
  const { data, error, isLoading } = useAiModelFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('ai_model', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/ai-models/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Compliance Score" text={data?.compliance_score} />
